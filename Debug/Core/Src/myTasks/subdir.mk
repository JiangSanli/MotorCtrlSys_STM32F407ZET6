...
Core/Src/myTasks/%.o Core/Src/myTasks/%.su Core/Src/myTasks/%.cyclo: ../Core/Src/myTasks/%.c Core/Src/myTasks/subdir.mk
...
clean-Core-2f-Src-2f-myTasks:
	-$(RM) ./Core/Src/myTasks/DetectionTask.cyclo ./Core/Src/myTasks/DetectionTask.d ./Core/Src/myTasks/DetectionTask.o ./Core/Src/myTasks/DetectionTask.su ./Core/Src/myTasks/messageTask.cyclo ./Core/Src/myTasks/messageTask.d ./Core/Src/myTasks/messageTask.o ./Core/Src/myTasks/messageTask.su ./Core/Src/myTasks/myTask03.cyclo ./Core/Src/myTasks/myTask03.d ./Core/Src/myTasks/myTask03.o ./Core/Src/myTasks/myTask03.su
