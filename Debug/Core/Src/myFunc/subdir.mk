...
Core/Src/myFunc/%.o Core/Src/myFunc/%.su: ../Core/Src/myFunc/%.c Core/Src/myFunc/subdir.mk
...
clean-Core-2f-Src-2f-myFunc:
	-$(RM) ./Core/Src/myFunc/FDC2112.d ./Core/Src/myFunc/FDC2112.o ./Core/Src/myFunc/FDC2112.su ./Core/Src/myFunc/MotorCtrl.d ./Core/Src/myFunc/MotorCtrl.o ./Core/Src/myFunc/MotorCtrl.su ./Core/Src/myFunc/ScheduleTable.d ./Core/Src/myFunc/ScheduleTable.o ./Core/Src/myFunc/ScheduleTable.su ./Core/Src/myFunc/myADC.d ./Core/Src/myFunc/myADC.o ./Core/Src/myFunc/myADC.su
